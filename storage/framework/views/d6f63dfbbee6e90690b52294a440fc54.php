    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card bg-white"
            ...
            <div class="card-header bg-white border-bottom p-4">
                ...
                <form action="<?php echo e(route('koor.raportSiswa')); ?>" method="GET" class="d-flex align-items-center mb-3 mb-md-0 w-100" style="max-width: 550px;">
                    <div class="input-group me-2"
                        ...
                        <input type="text" name="search" class="form-control border-0 shadow-none px-2" 
                            placeholder="Cari nama siswa..." value="<?php echo e(request('search')); ?>" style="background: transparent;">
                    </div>
                    ...
                    <?php if(request('search')): ?>
                        <a href="<?php echo e(route('koor.raportSiswa')); ?>" class="btn rounded-pill px-3 fw-semibold text-dark shadow-none d-flex align-items-center" 
                            ...
                            <?php for($i = 0; $i < 5; $i++): ?>
                                <tr>
                                    <td colspan="4" class="text-center py-4 text-muted border-0">
                                        <?php if($i == 2): ?> <i class="bx bx-folder-open d-block fs-2 mb-1"></i> Belum ada data siswa. <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endfor; ?>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\LenteraFajar\lenterafajarbe\resources\views/admin/raport-siswa/index.blade.php ENDPATH**/ ?>