<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            setupImageInput(
                'photo_edit_<?php echo e($student->id); ?>',
                'preview_container_edit_<?php echo e($student->id); ?>',
                'preview_edit_<?php echo e($student->id); ?>',
                'error_photo_edit_<?php echo e($student->id); ?>'
            );
            ...
            Swal.fire({
                ...
                html: `
                        <div style="text-align: left; background: #f8f9fa; padding: 15px; border-radius: 10px; border: 1px dashed #d9dee3;">
                            ...
                            <hr class="my-2">
                            <p class="mb-1"><strong>Email:</strong> <span class="text-primary"><?php echo e(session('parent_credentials')['email']); ?></span></p>
                            <p class="mb-0"><strong>Password Baru:</strong> <span class="text-success"><?php echo e(session('parent_credentials')['password']); ?></span></p>
                        </div>
                    `,
                icon: 'info',
...
<?php endif; ?><?php /**PATH D:\LenteraFajar\lenterafajarbe\resources\views/admin/anak/_scripts.blade.php ENDPATH**/ ?>