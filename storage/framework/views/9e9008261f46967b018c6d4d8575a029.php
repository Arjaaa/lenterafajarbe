    ...
    <div class="card bg-white"
        ...
        <div
            ...
            <div class="mb-3 mb-md-0 w-100" style="max-width: 500px;">
                <form action="<?php echo e(url()->current()); ?>" method="GET"
                    class="d-flex align-items-center mb-3 mb-md-0 w-100">
        ...
        <div class="table-responsive text-nowrap" style="overflow-x: auto; -webkit-overflow-scrolling: touch;">
            <table class="table custom-table-striped table-borderless" style="min-width: 1000px;">
                ...
                <tbody>
                    <?php $__empty_1 = true;
                    $__currentLoopData = $worksheets ?? [];
                    $__env->addLoop($__currentLoopData);
                    foreach ($__currentLoopData as $index => $worksheet):
                        $__env->incrementLoopIndices();
                        $loop = $__env->getLastLoop();
                        $__empty_1 = false; ?>
                        <tr>
    ...
    <div class="modal fade" id="modalAssignWorksheet" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="border-radius: 20px; border: none;">
                ...
                <form action="<?php echo e(route('koor.worksheet.store')); ?>" method="POST"
                                    ...
                                    foreach ($__currentLoopData as $student):
                                        ...
                                        <?php if (isset($student->id)): ?>
                                            <option value="<?php echo e($student->id); ?>">
                                                <?php echo e($student->name ?? 'Tanpa Nama'); ?>
                                            </option>
                                        <?php endif; ?>
                                    <?php endforeach;
                                    $__env->popLoop();
                                    ...
                                    foreach ($__currentLoopData as $teacher):
                                        ...
                                        <?php if (isset($teacher->id)): ?>
                                            <option value="<?php echo e($teacher->id); ?>">
                                                <?php echo e($teacher->name ?? 'Tanpa Nama'); ?>
                                            </option>
                                        <?php endif; ?>
                                    <?php endforeach;
                                    $__env->popLoop();
