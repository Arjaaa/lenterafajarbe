            ...
            <div class="card h-100 bg-white"
                ...
                <div class="card-body d-flex flex-column align-items-center justify-content-center py-4">
                    ...
                    <div class="mb-2 donut-chart"
                        ...
                        <span
                            class="fw-bold text-dark donut-text"><?php echo e($fbGiven); ?>/<?php echo e($fbTotal); ?></span>
                    </div>
            ...
            <div class="card h-100 bg-white"
                ...
                <div class="card-body d-flex flex-column align-items-center justify-content-center py-4">
                    ...
                    <div class="mb-2 donut-chart"
                        ...
                        <div class="donut-inner"></div>
                        <span
                            class="fw-bold text-dark donut-text"><?php echo e($lmFeedback); ?>/<?php echo e($lmReports); ?></span>
                    </div>
    ...
    <div class="card bg-white"
        ...
        <div class="table-responsive text-nowrap" style="overflow-x: auto; -webkit-overflow-scrolling: touch;">
            <table class="table custom-table-striped table-borderless" style="min-width: 900px;">
                ...
                <tbody>
                    <?php $__empty_1 = true;
                    $__currentLoopData = $teachers ?? [];
                    $__env->addLoop($__currentLoopData);
                    foreach ($__currentLoopData as $index => $teacher):
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-dark fw-medium"><?php echo e($teacher->teacher->name ?? '-'); ?>
                            </td>
                                ...
                                <div class="d-flex justify-content-start align-items-center gap-2">
                                    ...
                                    <?php if (!($teacher->has_feedback ?? false)): ?>
                                        <button type="button"
                                            ...
                                            data-bs-target="#feedbackModal<?php echo e($teacher->id); ?>">
