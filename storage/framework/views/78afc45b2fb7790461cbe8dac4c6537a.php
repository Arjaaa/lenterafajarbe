        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card bg-primary text-white">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-8">
                        <div class="card-body">
                            <h5 class="card-title text-white">Selamat Datang, <?php echo e(auth()->user()->name ?? 'Koordinator'); ?>!
                                🎉</h5>
        ...
        <div class="col-lg-3 col-md-6 col-6 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <h3 class="card-title mb-2"><?php echo e($totalAnak); ?></h3>
        ...
        <div class="col-lg-3 col-md-6 col-6 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <h3 class="card-title mb-2"><?php echo e($totalOrtu); ?></h3>
        ...
        <div class="col-lg-3 col-md-6 col-6 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <h3 class="card-title mb-2"><?php echo e($totalGuru); ?></h3>
        ...
        <div class="col-lg-3 col-md-6 col-6 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <h3 class="card-title mb-2"><?php echo e($totalKelasAktif); ?></h3>
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-4 border-end">
                            <div class="fs-3 fw-semibold text-primary mb-1"><?php echo e($totalKelasUmum); ?></div>
                            <span class="text-muted d-block"><i class="bx bx-chalkboard me-1"></i>Kelas Reguler</span>
                        </div>
                        <div class="col-4 border-end">
                            <div class="fs-3 fw-semibold text-warning mb-1"><?php echo e($totalGroupShadow); ?></div>
                            <span class="text-muted d-block"><i class="bx bx-group me-1"></i>Group Shadow</span>
                        </div>
                        <div class="col-4">
                            <div class="fs-3 fw-semibold text-info mb-1"><?php echo e($total1on1); ?></div>
