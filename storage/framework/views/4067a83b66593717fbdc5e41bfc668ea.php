    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card bg-white"
           ...
           <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-center bg-white border-bottom p-4">
                ...
                <form action="<?php echo e(url()->current()); ?>" method="GET" class="d-flex align-items-center w-100" style="max-width: 550px;">
                    
                    
                    <?php if(request()->filled('student_id')): ?> <input type="hidden" name="student_id" value="<?php echo e(request('student_id')); ?>"> <?php endif; ?>
                    <?php if(request()->filled('date')): ?> <input type="hidden" name="date" value="<?php echo e(request('date')); ?>"> <?php endif; ?>
                    <?php if(request()->filled('month')): ?> <input type="hidden" name="month" value="<?php echo e(request('month')); ?>"> <?php endif; ?>
                    ...
                    <div class="input-group me-2" style="border-radius: 50px; overflow: hidden; border: 1px solid #a3c7fb; background: white;">
                        ...
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" class="form-control border-0 shadow-none px-2" placeholder="Cari nama siswa/terapis..." style="background: transparent;">
                    </div>
            ...
            <div class="card-footer bg-white border-top text-center py-4">
                ...
                <div class="d-inline-flex align-items-center bg-white px-3 py-2 border shadow-sm"
                    style="border-radius: 50px;">
                     ...
                     <a
                        href="<?php echo e($currentPage > 1 ? request()->fullUrlWithQuery(['page' => $currentPage - 1]) : 'javascript:void(0)'); ?>"
