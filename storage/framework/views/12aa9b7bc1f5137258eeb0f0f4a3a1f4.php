...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'modalTambahAnak','title' => 'Tambah Data Anak Baru','size' => 'modal-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modalTambahAnak','title' => 'Tambah Data Anak Baru','size' => 'modal-lg']); ?>
    ...
    <form action="<?php echo e(route('koor.storeAnak')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH D:\LenteraFajar\lenterafajarbe\resources\views/admin/anak/_modal-tambah.blade.php ENDPATH**/ ?>