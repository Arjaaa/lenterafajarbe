...
<div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <button type="button" class="btn btn-sm rounded-pill px-3 py-1 me-1 text-white shadow-none"
                                    ...
                                    data-bs-target="#modalEdit1on1<?php echo e($sesi->id ?? 0); ?>" title="Edit">
                                    <i class="bx bx-edit-alt me-1" style="font-size: 0.9rem;"></i> Edit
                                </button>

                                
                                <form action="<?php echo e(route('koor.destroy1on1', $sesi->id ?? 0)); ?>" method="POST" class="d-inline"
                                   ...
                                   <button type="button" class="btn btn-sm rounded-pill px-3 py-1 text-white shadow-none"
                                    ...
                                    data-bs-toggle="modal" data-bs-target="#modalDelete1on1<?php echo e($sesi->id ?? 0); ?>">
    ...
    <?php $__currentLoopData = $oneOnOnes ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sesi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="modal-content text-center" style="border-radius: 20px; border: none;">
            ...
            <div class="modal-body p-4 text-wrap">
                ...
                <p class="text-muted mb-4 text-wrap" style="font-size: 0.9rem;">
                    Data sesi <strong><?php echo e($sesi->name ?? 'ini'); ?></strong> akan dihapus permanen dan tidak dapat dikembalikan.
                </p>
